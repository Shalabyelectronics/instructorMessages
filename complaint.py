...
class Complaint():
    def __init__(self):
        self.student_name = input(
            "Write your first and last name, please : ").title()
        self.instructor_name = input("What is your instructor name : ").title()
        self.course_name = input(
            "Which course are you currently doing? ").title()
        self.unit_number = input(
            "Which unit is your complaint related to it? ")
    ...
    def proof_questions(self):
        if self.issue_details == "unfairly graded":
            ...
            add_proof = input(
                "Do you want to add another poof for unfairly graded issue?").lower()
            ...
            add_proof = input(
                "Can you provide the link where the offensive comment is located? ?").lower()
            if add_proof == "y" or add_proof == "yes":
                self.proof_two = input(
            ...
            add_proof = input(
                f"Do you want to add another poof for {self.issue_details} ?").lower()
            if add_proof == "y" or add_proof == "yes":
                self.proof_one = input(
                    f"What is your proof about {self.issue_details}")
