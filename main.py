...
if proceed():
    ...
    while not is_true:
        ...
        is_true = multiple_choices_checker(
            x=user_complaint_part, question=ASSIGNMENTS_SECTION
        )
        if not is_true:
    ...
    while not is_true:
        ...
        if not is_true:
            ...
            if user_issue.lower() == "c":
                ...
                user_issue_more_details = input(
                    "Would you please give more details why you think you unfairly "
                    "graded?\n"
                )
